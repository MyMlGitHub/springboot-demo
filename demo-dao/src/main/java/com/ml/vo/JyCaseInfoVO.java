...
public class JyCaseInfoVO {
    ...
    private Integer beforePersonnelId;

    private String beforePersonnelName;

    private String adjustCityCode;

    private String adjustCityName;

    private String adjustType;

    private String adjustReturn;

    private String adjustReturnRemark;
    ...
    private String beforeAdjustPointCode;

    private String beforeAdjustPointName;

    private String acquireMessageInfo;
    ...
    private String bigAdjustId;

    private String casePoolMode;
    ...
    private Integer beforeAdjustOrgCode;

    private String beforeAdjustOrgName;
